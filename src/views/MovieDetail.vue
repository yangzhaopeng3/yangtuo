<template>
  <div class="container">
    ...
    <div class="make_comment">
      <el-button style="width: 60px;font-size: 14px" @click="makeWish" size="small" type="warning"
                 plain>想看
      </el-button>
      <el-button v-if="myRate == null || myRate.cid==null" style="width: 60px;font-size: 14px" @click="makeRate"
                 size="small"
                 type="warning" plain>看过
      </el-button>
      <el-button v-else style="width: 60px;font-size: 14px" @click="makeRate" size="small"
